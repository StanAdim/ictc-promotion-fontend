...
<template>
  <div
    id="toast-success"
    :class="{'hidden': isHidden, ' bg-red-600 py-2 ':isFailed, ' bg-green-600 text-2xl px-5 py-2 ':isSucceed}"
  ...
  >
    ...
    <button
      ...
      class="ms-auto mx-1.5 -my-1.5  text-white hover:text-red-900 
      rounded-lg focus:ring-2 focus:ring-orange-300 p-1.5 inline-flex 
